...
@section('content')
<section class="edit-publication">
    <div class="container">
        <h1 class="section-title">Modifier la publication</h1>
        ...
        <div class="publication-form">
            <form action="{{ route('professor.publications.update', $publication->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="titre_pub" name="titre_pub" 
                           value="{{ old('titre_pub', $publication->titre_pub) }}" required>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="year" name="year" 
                               value="{{ old('year', $publication->year->format('Y-m-d')) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload">
                            <label for="image" class="file-upload-label">
                                ...
                                <span id="file-name">Choisir un nouveau fichier...</span>
                            </label>
